...
public class ModVillagers {
    public static final DeferredRegister<PoiType> POI_TYPES =
            DeferredRegister.create(ForgeRegistries.POI_TYPES, SimpleFastFood.MODID);
    public static final DeferredRegister<VillagerProfession> VILLAGER_PROFESSIONS =
            DeferredRegister.create(ForgeRegistries.VILLAGER_PROFESSIONS, SimpleFastFood.MODID);

    public static final RegistryObject<PoiType> CHECKOUT_MACHINE_POI = POI_TYPES.register("checkout_machine_poi",
            () -> new PoiType(ImmutableSet.copyOf(ModBlocks.CHECKOUT_MACHINE.get().getStateDefinition().getPossibleStates()),
                    1, 1));
